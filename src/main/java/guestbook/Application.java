...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
			new GuestbookEntry("H4xx0r", "first!!!", "2055550125"), //
			new GuestbookEntry("Arni", "Hasta la vista, baby", "202 555 0125"), //
			new GuestbookEntry("Duke Nukem",
					"It's time to kick ass and chew bubble gum. And I'm all out of gum.", "+111 636 85 67 89"), //
